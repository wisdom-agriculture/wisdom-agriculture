<template>
  <view class="informed">
    <h4 class="title">智慧农业综合服务云平台隐私政策</h4>
    <p class="indentation">您好，欢迎来到<b>智慧农业综合服务云平台。</b></p>
    <p class="indentation">
    ...
    <ul>
      ...
      <li>存储信息的地点和期限，您的个人信息如何在全球范围转移</li>
      <li>本隐私政策如何更新</li>
      <li>广告/我们向您发送的信息</li>
      <li>适用范围</li>
      <li>其他</li>
    ...
    <p>
      (1)
      业务功能：当你注册成为我们用户。我们会基于您提供的手机号码向您发送短信验证码，用于验证您的身份。
    </p>
    <p>
    ...
    <p>
      (3)
      业务功能：发布UGC内容。当您使用发布UGC内容服务时，为提供UGC的素材，您需要提供以下功能、信息供我们收集：相册权限、摄像头权限、个人位置权限。
    </p>
    <p>若您不提供这类信息，您可能无法正常使用发送社区动态的服务。</p>
    <p>
      在使用过程中，如果您提供以下额外信息，将有助于我们给您提供更好的服务和体验：个人位置信息。但如果您不提供这些信息，将不会影响使用本服务的基本业务功能。
    </p>
    <p>个人位置信息属于敏感信息。</p>
    ...
    <p>(7) 智慧农业综合服务云平台 App所调用的系统权限</p>
    <p>
      如上所述，为了向您提供智慧农业综合服务云平台产品与/或服务，我们可能需要使用您设备中的系统权限（不包括所接入第三方调用的权限）来收集相关个人信息。尽管我们在前述 章节中已经有所涉及，本节将对智慧农业综合服务云平台App所使用的所有系统权限进行归纳整理，以方便向您更加系统、完整、透明地呈现。您可以选择是否授权我们使用您设备的相关权限，如果您不授权我们使用相 关权限，可能会导致部分服务无法使用，但是不影响您使用智慧农业综合服务云平台App的其他功能。
    </p>
    <p>
    ...
    <p>您可以通过与智慧农业综合服务云平台客服联系的方式，申请个人信息副本。</p>
    ...
    <p>6、存储信息的地点和期限，您的个人信息如何在全球范围转移</p>
