                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="48" height="48">
                                ...
                                <g>
                                    ...
                                    <path
                                        ...
                                        fill="#FFB257" p-id="12478"></path>
                                </g>
                            </svg>
                        </div>
                    </div>
                    <div>
                        最低：<a-input v-model:value="setting['lumination'].lower"></a-input>{{setting['lumination'].unit}}
                    </div>
                    <div>
                        最高：<a-input v-model:value="setting['lumination'].upper"></a-input>{{setting['lumination'].unit}}
                    </div>
                </div>
                <div class="card">
                    <div>CO₂浓度</div>
                    <div class="textIcon"><svg xmlns="http://www.w3.org/2000/svg"
                            class="styles__StyledSVGIconPathComponent-sc-16fsqc8-0 fPsHiw svg-icon-path-icon"
                            viewBox="0 0 1024 1024" width="65" height="65">
                            <defs data-reactroot=""></defs>
                            <g>
                                <path
                                ...
                                <path
                                    ...
                                    fill="#1A1A1A" p-id="13137"></path>
                            </g>
                        </svg>
                    </div>
                    <div>
                        最低：<a-input v-model:value="setting['CO2'].lower"></a-input>{{setting['CO2'].unit}}
                    </div>
                    <div>
                        最高：<a-input v-model:value="setting['CO2'].upper"></a-input>{{setting['CO2'].unit}}
                    </div>
                </div>
                <div class="card">
                    <div>土壤温度</div>
                    <div class="textIcon"><svg xmlns="http://www.w3.org/2000/svg"
                            class="styles__StyledSVGIconPathComponent-sc-16fsqc8-0 fPsHiw svg-icon-path-icon"
                            viewBox="0 0 1024 1024" width="70" height="70">
                            <defs data-reactroot=""></defs>
                            <g>
                                <path
                    ...
                    <div>
                        最低：<a-input v-model:value="setting['temperature'].lower"></a-input>
                        {{setting['temperature'].unit}}
                    </div>
                    <div>
                        最高：<a-input v-model:value="setting['temperature'].upper"></a-input>
                        {{setting['temperature'].unit}}
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="textIcon">
                        <div><svg xmlns="http://www.w3.org/2000/svg"
                                class="styles__StyledSVGIconPathComponent-sc-16fsqc8-0 fPsHiw svg-icon-path-icon"
                                viewBox="0 0 1024 1024" width="60" height="60">
                                <defs data-reactroot=""></defs>
                                <g>
                                    <path
                    ...
                    <div>
                        最低：<a-input v-model:value="setting['humidity'].lower"></a-input>{{setting['humidity'].unit}}
                    </div>
                    <div>
                        最高：<a-input v-model:value="setting['humidity'].upper"></a-input>{{setting['humidity'].unit}}
                    </div>
                </div>
                <div class="card">
                    <div>土壤PH值</div>
                    <div class="textIcon"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g>
                                <path
                                    ...
                                    fill="#2FAF48" p-id="11572" data-spm-anchor-id="a313x.7781069.0.i22"
                                    class="selected"></path>
                                <path
                    ...
                    <div>
                        最低：<a-input v-model:value="setting['pH'].lower"></a-input>{{setting['pH'].unit}}
                    </div>
                    <div>
                        最高：<a-input v-model:value="setting['pH'].upper"></a-input>{{setting['pH'].unit}}
                    </div>
                </div>
...
import apis, { getPlotRes } from '@/tools/apis';
...
const setting = ref<{ [key in string]: envSettingItem }>({
    humidity: {
        upper: 16,
        lower: 8,
        unit: '%'
...
.card {
    ...
    align-items: center;
    background-color: rgba(47, 175, 72, 0.7);
    border-radius: 16px;
    padding: 24px;
