...
import com.yaohy.intelligentfarmingbackend.config.AlipayConfig;
...
public class AliPayController {
    ...
    @App
    @Web
    @RequestMapping(value = "/alipay/pay",method = RequestMethod.GET, produces = {"text/html;charset=UTF-8"})
