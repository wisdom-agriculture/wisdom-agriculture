package com.yaohy.intelligentfarmingbackend.aop;
...
//                    "\"text\":" + "\"" + webLog + "\"" + "\n" +
//                    "}");
//            Object object = restTemplate.postForObject("飞书的webhook地址", map, Object.class);
//        }
        return result;
    }
    ...
    public void larkRobot(JoinPoint point, Exception exception) {
        if (larkRobot.getDev().equals("true")) return;
